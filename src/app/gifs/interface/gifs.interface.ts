export interface SearchGisfResponse {
    data:       Gif[];
...
export class Convert {
    public static toSearchGisfResponse(json: string): SearchGisfResponse {
        return cast(JSON.parse(json), r("SearchGisfResponse"));
    }

    public static searchGisfResponseToJson(value: SearchGisfResponse): string {
        return JSON.stringify(uncast(value, r("SearchGisfResponse")), null, 2);
    }
}
